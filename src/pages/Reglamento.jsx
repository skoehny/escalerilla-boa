...
export default function Reglamento() {
  ...
  const faqs = [
    ...
    { q: '¿Qué pasa si no juego? (inactividad)', a: 'El reloj cuenta los días sin jugar desde tu último partido. A los 14 días bajas 2 puestos; a los 21, 1 más; a los 28, 1 más y quedas lesionado; y 1 más por cada 7 días extra. Tener un desafío activo (pendiente o aceptado) pausa el reloj. El #1 es la excepción: mientras esté sano su reloj queda congelado donde esté (no puede desafiar a nadie, solo ser desafiado). Pero si el #1 se marca lesionado, el reloj corre desde ese mismo valor y penaliza normal: nadie puede desafiar a un lesionado, así que el reloj es lo que evita que la punta quede bloqueada.' },
  ...
  return (
    <div>
      ...
      <Rule n="4" title="Inactividad">
        ...
        <p style={{ marginTop: 8 }}><strong>El #1 sano no acumula inactividad:</strong> quien está en la punta no puede desafiar a nadie (solo puede ser desafiado), así que su inactividad no depende de él. Mientras esté sano su reloj queda <strong>congelado donde esté</strong>: no avanza, no baja puestos y no lo marca lesionado. Ojo: congelado no es borrado — lo único que lo reinicia a 0 es <strong>jugar</strong>. Puede ser desafiado en cualquier momento, y si pierde, baja con el reloj en 0.</p>
        <p style={{ marginTop: 4 }}>• <strong>Si el #1 se lesiona</strong>, su reloj <strong>corre desde donde quedó</strong> y penaliza normal (14 días: −2 puestos, y así). Un lesionado no puede ser desafiado, así que un #1 lesionado bloquearía la punta: el reloj es lo que la libera. Darse de alta desde el perfil lo vuelve a congelar, pero no lo baja: los días lesionado se van sumando vuelta a vuelta.</p>
      ...
      <Rule n="7" title="Lesiones">
        ...
        <p style={{ marginTop: 8 }}>Mientras estés inactivo, el reloj de inactividad sigue corriendo aunque estés marcado como lesionado. Es la única situación en que el reloj del #1 corre.</p>
      </Rule>
